        ...
        while ($Choice -ne 0) {
            switch ($Choice) {
                1 {
                    ...
                    Add-DecoyUser -Username "avi_ad2" `
                                  -SPN "postgres/WEBHOST-9.CHOICECORP.NET,mongod/WEBHOST-9.CHOICECORP.NET,mongos/WEBHOST-9.CHOICECORP.NET,ftp/WEBHOST-9.CHOICECORP.NET,nfs/WEBHOST-9.CHOICECORP.NET,SAP/WEBHOST-9.CHOICECORP.NET,SAPService/WEBHOST-9.CHOICECORP.NET" `
                                  -LogonWkst "PLC16" `
                                  -Domain "choicecorp.net" `
                                  -ProfilePath "\\WEBHOST-9\downloads" `
                                  -Description "" `
                ...
                3 {
                    ...
                    Remove-DecoyUser -Username "avi_ad2" -Deployed $True
                   $Choice = -1
                }
                4 {
                   $Choice = -1
                ...
                7 {
                    ...
                    Test-DecoyUserDeployment -Username "avi_ad1" `
                                             ...
                                             -TelephoneNumber "" `
                                             -Email ""
                    Test-DecoyUserDeployment -Username "avi_ad2" `
                                             -SPN "postgres/WEBHOST-9.CHOICECORP.NET,mongod/WEBHOST-9.CHOICECORP.NET,mongos/WEBHOST-9.CHOICECORP.NET,ftp/WEBHOST-9.CHOICECORP.NET,nfs/WEBHOST-9.CHOICECORP.NET,SAP/WEBHOST-9.CHOICECORP.NET,SAPService/WEBHOST-9.CHOICECORP.NET" `
                                             -LogonWkst "PLC16" `
                                             -Domain "choicecorp.net" `
                                             -ProfilePath "\\WEBHOST-9\downloads" `
                ...
                8 {
                    Send-DeploymentJson -Mode $SendMode -Domain "choicecorp.net" -Receiver $Receiver -Token "FZKBO7D2RO7GBBO98EAUUGY5R056PR4HKXDI3ZDWFONSW26LC04EW7KG5CRDAIR7"
                    $Choice = -1
                }
                0 {
